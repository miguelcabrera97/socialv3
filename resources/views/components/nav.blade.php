    ...
    <div class="fixed sm:w-1/4 lg:w-1/5 xl:w-1/6 hidden md:block p-8 border-r h-screen border-gray-200">
        ...
        <ul>
            <a href="{{route('home')}} ">
                <li class="flex mb-8 rounded-md px-4 py-2 hover:bg-sky-500 {{request()->routeIs('home')?' active:bg-sky-600':''}}                    ">
                <div class=" shadow-sm p-2 rounded-lg mr-3">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                    </svg>
                </div>
                <span class="self-center font-light">Inicio</span> 
                </li>
            </a>
            ...
            <li class="flex rounded-md px-4 py-2 mb-8 hover:bg-sky-500">
                ...
                <span class="self-center font-light">Soporte</span> 
            </li>
        </ul>

        <h6 class="font-bold mb-4">Configuracion</h6>
        <ul>
            ...
            <li class="flex rounded-md px-4 py-2 mb-8 hover:bg-sky-500">
                ...
                <span class="self-center font-light">Perfil</span> 
            </li></a>
            <li class="flex rounded-md px-4 py-2 mb-8 hover:bg-sky-500">
                <div class=" shadow-sm p-2 rounded-lg mr-3">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                ...
                <span class="self-center font-light">Ajustes</span> 
            </li>
        </ul>
    </div>
